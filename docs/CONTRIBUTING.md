...
## Build Protocol
1. Claude reads the realm's open items and plans from the base — `python ../resonance-progenatrix/progenatrix.py recall --realm resonance-echoes` — and the relevant blueprints
