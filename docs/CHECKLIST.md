...
- [ ] S22 Ultra install — at its own moment
- [ ] Functional seams verify as KP explores: export past 200 · envelope round-trip · pause across navigation · each chime at volume
