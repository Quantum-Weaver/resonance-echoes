...
- [x] Version → 1.3.0 (package.json + tauri.conf.json)
- [ ] Build (desktop + Android) → sign (KP's hand, by the release ritual) → install both phones → device-verify: export past 200 · envelope round-trip · pause across navigation · each chime at volume
